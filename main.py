...
if __name__ == "__main__":
    ...
    while True:
        ...
        cpm = telmunnshop.Telmunnshop(acc_access_key)
        ...
        while True:
            ...
            console.print("[bold cyan](09): Delete Friends ~ FREE[/bold cyan]")
            console.print("[bold cyan](10): Unlock Paid Cars + Siren ~ FREE[/bold cyan]")
            console.print("[bold cyan](11): Unlock w16 Engine ~ FREE[/bold cyan]")
            console.print("[bold cyan](12): Unlock All Horns ~ FREE[/bold cyan]")
            console.print("[bold cyan](13): Unlock Disable Damage ~ FREE[/bold cyan]")
            console.print("[bold cyan](14): Unlock Unlimited Fuel ~ FREE[/bold cyan]")
            console.print("[bold cyan](15): Unlock House 3 ~ FREE[/bold cyan]")
            console.print("[bold cyan](16): Unlock Smoke ~ FREE[/bold cyan]")
            console.print("[bold cyan](17): Change Race Wins ~ FREE[/bold cyan]")
            console.print("[bold cyan](18): Change Race Loses ~ FREE[/bold cyan]")
            console.print("[bold cyan](19): Clone Account ~ FREE[/bold cyan]")
            console.print("[bold cyan](20): Unlock all Cars ~ FREE[/bold cyan]")
            console.print("[bold cyan](21): Unlock Siren all Cars ~ FREE[/bold cyan]")
            console.print("[bold cyan](22): Unlock Lamborghinis 299hp (IOS Only) ~ FREE[/bold cyan]")
            console.print("[bold cyan](23): Hack Car Speed (299hp) ~ FREE[/bold cyan]")
            console.print("[bold cyan](24): Remove Front Bumper ~ FREE[/bold cyan]")
            console.print("[bold cyan](25): Remove Rear Bumper ~ FREE[/bold cyan]")
